"""SANRI OS v1 foundation tables and RLS.
...
def downgrade() -> None:
    op.execute("drop table if exists public.v1_memories")
    op.execute("drop table if exists public.v1_messages")
    op.execute("drop table if exists public.v1_conversations")
    op.execute("drop table if exists public.v1_projects")
    op.execute("drop table if exists public.v1_aura_states")
