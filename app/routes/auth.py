...
JWT_SECRET = os.getenv("JWT_SECRET") # Railway'de şart
...
def set_auth_cookie(resp: Response, token: str):
    # Cookie da basalım (bazı cihazlarda çalışır)
    resp.set_cookie(
        key=COOKIE_NAME,
        value=token,
        ...
        secure=True,
        samesite="none",
        # domain vermiyoruz: cookie sorun çıkarıyorsa token zaten body'de
        path="/",
    )
